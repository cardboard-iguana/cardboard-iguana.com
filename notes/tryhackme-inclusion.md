...
This room is intended to focus on [local file inclusion attacks](LFI%20(Local%20File%20Inclusion)%20Attacks.md), so my guess is that hitting the machine with [nmap](nmap.md) and [gobuster](gobuster.md) is probably unnecessary. But, I'm going to do it anyway, just in case.
