...
I didn't get around to watching the account abstraction panel from Devcon Bogota yesterday, so some notes for that follow.

* [Devcon](https://devcon.org/)
* [2022-11-14 - Devcon 6, Part 1](2022-11-14-devcon-6.md)

# David Hoffman, Julien Niset, Itamar Lesuisse, Vitalik Buterin, and Yoav Wiss: Account Abstraction Panel
